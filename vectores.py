                            #_______________________________VECTORES___________________________________


#Definicion, creacion y llenado de un vector 
n = int(input("De cuantas posiciones desea el Vector?: "))
cantidadPosiciones = n
vector = []
suma = 0

for i in range(cantidadPosiciones):
  posicion = int(input(f'Ingresa el dato de la posicon numero {i + 1}: '))
...
print(vector)
print(f'La suma de todas las posiciones es igual a:', suma)
...
for i in range(10):         #Entrada de datos
    vector[i] = int(input(f'Digite el dato que quiere poner en la posicion {i+1} del vector'))
