...
#10. Un método que retorne la posición en la cual se halla un dato en el vector. buscarDato(d): retorna la posición en la cual 
# se halla el dato d en V. Si no encuentra el dato, retorna –1.
